(() => {
  ...
  // Subconscious hover feedback: a nearly inaudible glass harmonic, only on
  // meaningful navigation. Open Chapter stays completely silent.
  // v26: hover remains visually quiet; sound is reserved for deliberate clicks.
})();
